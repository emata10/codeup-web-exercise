...
function sayHello() {
    return "Hello, Emily Mata";
}
function greet(helloMessage, Emily){
    console.log(helloMessage);
}
...
function isTwo(number(2))
    if (number === 2) {
        ...
        console.log('The number ' + number + ' is not two!');
 ...
 */
    (function(){
         ...
         */
        alert('Your total with the tip is added will be $' + total)
    })();
/**
 * TODO:
